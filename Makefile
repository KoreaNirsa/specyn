...
help:
	@echo "Specyn 명령어"
	@echo "  make setup            - .env 기반 초기 설정 및 Docker agent 인증 구성"
	@echo "  make auth-status      - 현재 인증/.env 상태 확인"
	...
	@echo "  make bootstrap        - 레거시 호스트 의존성 설치 및 로컬 폴더 준비"
	@echo "  make dev              - 레거시 dashboard(frontend/backend/ai-server) 실행"
	@echo "  make sample-dev       - 레거시 sample-service 실제 프로젝트 런타임 실행"
