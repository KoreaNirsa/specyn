...
/**
 * Provide security config behavior for the current module.
 */
@Configuration
...
public class SecurityConfig {
    ...
    /**
     * Handle security filter chain for the current workflow.
     */
    @Bean
    ...
    /**
     * Handle no local login user details service for the current workflow.
     */
    @Bean
    ...
    /**
     * Handle cors configuration source for the current workflow.
     */
    @Bean
    ...
    /**
     * Parse origins for the current workflow.
     */
